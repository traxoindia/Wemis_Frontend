...
//   return (
//     <div className="font-sans text-gray-200 min-h-screen bg-white">
//       <ManufactureNavbar />
//       <ToastNotification message={toast.message} type={toast.type} onClose={() => setToast({ message: '', type: null })} />

//       <nav className="bg-white backdrop-blur-xl border-b border-yellow-500/30 sticky top-0 z-40 px-6 py-4 flex items-center justify-between">
//         <div className="flex items-center gap-3">
//           <MapPin size={24} className='text-black' />
//           <h1 className="text-2xl font-black bg-black bg-clip-text text-transparent">WEMIS MAPPING</h1>
//         </div>
