...
const Navbar = () => {
  ...
  const navLinks = [
    { name: "Dashboard", icon: <MdDashboard />, path: "/superadmin/dashboard" },
  ];

  const elementLinks = [
    { name: "Element", icon: <MdDashboard />, path: "/superadmin/element" },
    { name: "Element Types", icon: <MdFormatListBulleted />, path: "/superadmin/element-types" },
    { name: "Model Numbers", icon: <MdNumbers />, path: "/superadmin/model-numbers" },
    { name: "Part Numbers", icon: <MdAssignment />, path: "/superadmin/part-numbers" },
    { name: "TAC Numbers", icon: <MdCheckCircle />, path: "/superadmin/tac-numbers" },
    { name: "COP Numbers", icon: <MdBusiness />, path: "/superadmin/cop-numbers" },
    // { name: "Testing Agency", icon: <MdAssignmentTurnedIn />, path: "/superadmin/testing-agency" },
    { name: "Assign Element", icon: <MdExtension />, path: "/superadmin/assign-element" },
  ];
    ...
    <div className="w-full bg-black/90 backdrop-blur-md shadow-lg fixed top-0 left-0 z-50 border-b border-yellow-500/30">
      ...
      <nav className="flex justify-center space-x-10 py-3 text-gray-300 font-medium">
        ...
        >
          ...
          >
            <MdDashboard className="text-xl" /> Onboard Admin
            <MdKeyboardArrowDown className="text-xl" />
          </button>
          ...
          <AnimatePresence>
            {isAdminDropdownOpen && (
              ...
              >
                ...
                >
                  <MdPersonAdd className="text-lg" /> Create Admin
                </Link>
                <Link
                ...
                >
                  <MdListAlt className="text-lg" /> Admin List
                </Link>
              </motion.div>
            )}
          </AnimatePresence>
